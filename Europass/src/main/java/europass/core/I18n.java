...
/**
 * Internationalization bundle singleton. Implemented as an enum as recommended
 * in Effective Java 2nd. Edition. Intended for inner use of the library only.
 */
public enum I18n {
	...
	public static final String LABELS_NAME = "europass.i18n.Labels";
	 ...
	 * 
	 * @param locale
	 *            Bundle that has been asked for.
	 * @param labelId
	 *            Name of the resource.
	 * @return Value of the resource.
	 */
